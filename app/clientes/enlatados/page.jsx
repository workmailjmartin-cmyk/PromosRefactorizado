...
export default function ListadoEnlatadosCliente() {
  ...
  }, [filtroTexto, filtroTransporte, filtroSalida, filtroOrden, paquetesOriginales]);
        ...
        <div className="container" style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ background: '#fff', padding: '15px 25px', borderRadius: '12px', border: '1px solid #e5e7eb', display: 'flex', flexWrap: 'wrap', gap: '15px', alignItems: 'flex-end', boxShadow: '0 4px 15px rgba(0,0,0,0.02)', marginBottom: '40px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flex: '0 0 auto' }}>
              <button onClick={() => { setFiltroTexto(''); setFiltroTransporte(''); setFiltroSalida(''); setFiltroOrden('recientes'); }} style={{ background: '#f3f4f6', color: '#4b5563', border: 'none', padding: '10px 20px', borderRadius: '6px', fontWeight: 'bold', cursor: 'pointer', fontSize: '0.9rem' }}>Limpiar</button>
            </div>
          </div>
